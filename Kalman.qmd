...
Imagine we had a time-varying parameter model where we estimate $\beta_t$; this becomes a time series so we have a lot of parameters to estimate: we outline an estimation method here, the _Kalman Filter_.
...
- Now we find $E [\beta_t | \psi_t]$ -- the best prediction of the unknown coefficient vector given _current_ information
