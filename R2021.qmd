...
## Selected ML and Dataviz techniques in R
...
```{r echo=FALSE, fig.align='center', out.width="33%", fig.cap="GitHub: 2020 (grey, left), 2021 (pink, right)", fig.show='hold'}
library(qrcode)
...
```{r echo=FALSE, fig.align='right', out.width="33%", out.extra='style="float:right"'}
